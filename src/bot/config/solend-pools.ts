...
const LENDING_MARKET = new PublicKey('4UpD2fh7xH3VP9QQaXtsS1YY3bxzWhtfpks7FatyKvdY'); // Main Pool
...
export const SOLEND_POOLS: Record<string, SolendPoolConfig> = {
    ...
    'So11111111111111111111111111111111111111112': {
        reserve: new PublicKey('8PbqLSWLu35vdPtCGKPuXfweG3PEPUpbQ5zX8z99f9sM'),
        liquiditySupply: new PublicKey('8UviNr47Sigi3wG16w7fFvAW96R3k2UDB9t85RBNnL6Z'),
        feeReceiver: new PublicKey('5Gdxn4yquneifE6uk9tK8X4CqHfWKjW2BvYU25hAykwP'), // fee receiver is usually the same host receiver for the pool
        lendingMarket: LENDING_MARKET,
        lendingMarketAuthority: LENDING_MARKET_AUTHORITY
    },
    // USDT Main Pool
    'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB': {
        reserve: new PublicKey('8K9WC8xoh2rtQNY7iEGftPvscMroscrnRxmUp3mN5LgZ'),
